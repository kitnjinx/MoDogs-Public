...
public class ModEntityTypes {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, MoDogs.MOD_ID);
    ...
    public static final RegistryObject<EntityType<RedboneCoonhoundEntity>> REDBONE_COONHOUND =
    ...
    public static final RegistryObject<EntityType<AmericanFoxhoundEntity>> AMERICAN_FOXHOUND =
    ...
    public static final RegistryObject<EntityType<RottweilerEntity>> ROTTWEILER =
