...
public class BorderCollieModel extends AnimatedGeoModel<BorderCollieEntity> {
    @Override
    public ResourceLocation getModelLocation(BorderCollieEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/border_collie.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(BorderCollieEntity object) {
        return BorderCollieRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(BorderCollieEntity animatable) {
