...
public class BoxerModel extends AnimatedGeoModel<BoxerEntity> {
    @Override
    public ResourceLocation getModelLocation(BoxerEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/boxer.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(BoxerEntity object) {
        return BoxerRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(BoxerEntity animatable) {
