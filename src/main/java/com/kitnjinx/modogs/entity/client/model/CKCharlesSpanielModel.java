...
public class CKCharlesSpanielModel extends AnimatedGeoModel<CKCharlesSpanielEntity> {
    @Override
    public ResourceLocation getModelLocation(CKCharlesSpanielEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/ck_charles_spaniel.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(CKCharlesSpanielEntity object) {
        return CKCharlesSpanielRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(CKCharlesSpanielEntity animatable) {
