...
public class DachshundModel extends AnimatedGeoModel<DachshundEntity> {
    @Override
    public ResourceLocation getModelLocation(DachshundEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/dachshund.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(DachshundEntity object) {
        return DachshundRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(DachshundEntity animatable) {
