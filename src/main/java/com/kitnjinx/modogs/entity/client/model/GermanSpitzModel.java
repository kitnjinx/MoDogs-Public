...
public class GermanSpitzModel extends AnimatedGeoModel<GermanSpitzEntity> {
    @Override
    public ResourceLocation getModelLocation(GermanSpitzEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/german_spitz.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(GermanSpitzEntity object) {
        return GermanSpitzRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(GermanSpitzEntity animatable) {
