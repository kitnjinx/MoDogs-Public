...
public class IrishSetterModel extends AnimatedGeoModel<IrishSetterEntity> {
    @Override
    public ResourceLocation getModelLocation(IrishSetterEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/irish_setter.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(IrishSetterEntity object) {
        return IrishSetterRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(IrishSetterEntity animatable) {
