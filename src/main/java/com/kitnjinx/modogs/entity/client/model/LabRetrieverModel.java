...
public class LabRetrieverModel extends AnimatedGeoModel<LabRetrieverEntity> {
    @Override
    public ResourceLocation getModelLocation(LabRetrieverEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/lab_retriever.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(LabRetrieverEntity object) {
        return LabRetrieverRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(LabRetrieverEntity animatable) {
