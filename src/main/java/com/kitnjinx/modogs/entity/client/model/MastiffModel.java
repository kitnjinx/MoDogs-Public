...
public class MastiffModel extends AnimatedGeoModel<MastiffEntity> {
    @Override
    public ResourceLocation getModelLocation(MastiffEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/mastiff.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(MastiffEntity object) {
        return MastiffRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(MastiffEntity animatable) {
