...
public class MiniPinscherModel extends AnimatedGeoModel<MiniPinscherEntity> {
    @Override
    public ResourceLocation getModelLocation(MiniPinscherEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/mini_pinscher.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(MiniPinscherEntity object) {
        return MiniPinscherRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(MiniPinscherEntity animatable) {
