...
public class PoodleModel extends AnimatedGeoModel<PoodleEntity> {
    @Override
    public ResourceLocation getModelLocation(PoodleEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/poodle.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(PoodleEntity object) {
        return PoodleRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(PoodleEntity animatable) {
