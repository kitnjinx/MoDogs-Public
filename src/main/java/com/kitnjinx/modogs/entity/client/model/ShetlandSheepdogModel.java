...
public class ShetlandSheepdogModel extends AnimatedGeoModel<ShetlandSheepdogEntity> {
    @Override
    public ResourceLocation getModelLocation(ShetlandSheepdogEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/shetland_sheepdog.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(ShetlandSheepdogEntity object) {
        return ShetlandSheepdogRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(ShetlandSheepdogEntity animatable) {
