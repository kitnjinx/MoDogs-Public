...
public class ShibaInuModel extends AnimatedGeoModel<ShibaInuEntity> {
    @Override
    public ResourceLocation getModelLocation(ShibaInuEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/shiba_inu.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(ShibaInuEntity object) {
        return ShibaInuRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(ShibaInuEntity animatable) {
