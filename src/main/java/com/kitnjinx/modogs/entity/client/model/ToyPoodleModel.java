...
public class ToyPoodleModel extends AnimatedGeoModel<ToyPoodleEntity> {
    @Override
    public ResourceLocation getModelLocation(ToyPoodleEntity object) {
        return new ResourceLocation(MoDogs.MOD_ID, "geo/poodle.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(ToyPoodleEntity object) {
        return PoodleRenderer.LOCATION_BY_VARIANT.get(object.getVariant());
    }

    @Override
    public ResourceLocation getAnimationFileLocation(ToyPoodleEntity animatable) {
