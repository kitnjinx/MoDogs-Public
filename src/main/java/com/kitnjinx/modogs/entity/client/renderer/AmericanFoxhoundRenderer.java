...
public class AmericanFoxhoundRenderer extends GeoEntityRenderer<AmericanFoxhoundEntity> {
    ...
    public static final Map<ShadeVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(ShadeVariant.class), (var) -> {
                var.put(ShadeVariant.LIGHT,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/american_foxhound/american_foxhound_light.png"));
                var.put(ShadeVariant.MEDIUM,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/american_foxhound/american_foxhound_medium.png"));
                var.put(ShadeVariant.DARK,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/american_foxhound/american_foxhound_dark.png"));
            });
    ...
    @Override
    public void preRender(PoseStack poseStack, AmericanFoxhoundEntity animatable, BakedGeoModel model, @org.jetbrains.annotations.Nullable MultiBufferSource bufferSource, @org.jetbrains.annotations.Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
