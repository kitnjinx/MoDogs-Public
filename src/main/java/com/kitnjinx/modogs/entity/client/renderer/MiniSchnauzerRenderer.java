...
public class MiniSchnauzerRenderer extends GeoEntityRenderer<MiniSchnauzerEntity> {
    ...
    public static final Map<MiniSchnauzerVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MiniSchnauzerVariant.class), (var) -> {
                var.put(MiniSchnauzerVariant.PEPPER_SALT,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/schnauzer/schnauzer_pepper_salt.png"));
                var.put(MiniSchnauzerVariant.BLACK_SILVER,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/schnauzer/mini_schnauzer_black_silver.png"));
                var.put(MiniSchnauzerVariant.BLACK,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/schnauzer/schnauzer_black.png"));
            });
    ...
    @Override
    public void preRender(PoseStack poseStack, MiniSchnauzerEntity animatable, BakedGeoModel model, @org.jetbrains.annotations.Nullable MultiBufferSource bufferSource, @org.jetbrains.annotations.Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
