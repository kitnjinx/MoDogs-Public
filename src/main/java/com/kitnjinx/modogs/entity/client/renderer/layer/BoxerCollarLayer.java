...
public class BoxerCollarLayer extends GeoRenderLayer {
    ...
    public BoxerCollarLayer(GeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack poseStack, BoxerEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
