...
public class BullTerrierWhiteLayer extends GeoRenderLayer<BullTerrierEntity> {
    ...
    public BullTerrierWhiteLayer(GeoRenderer<BullTerrierEntity> entityRendererIn) {
