...
public class MiniSchnauzerCollarLayer extends GeoRenderLayer {
    ...
    public MiniSchnauzerCollarLayer(GeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack poseStack, MiniSchnauzerEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
