...
public class NorwegianElkhoundCollarLayer extends GeoLayerRenderer {
    ...
    public NorwegianElkhoundCollarLayer(IGeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Entity entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        RenderType cameo =  RenderType.armorCutoutNoCull(getCollarLocation((NorwegianElkhoundEntity) entityLivingBaseIn));
