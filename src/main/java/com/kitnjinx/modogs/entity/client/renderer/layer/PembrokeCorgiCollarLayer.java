...
public class PembrokeCorgiCollarLayer extends GeoLayerRenderer {
    ...
    private static final ResourceLocation MODEL = new ResourceLocation(MoDogs.MOD_ID, "geo/pembroke_corgi.geo.json");

    public PembrokeCorgiCollarLayer(IGeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Entity entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        RenderType cameo =  RenderType.armorCutoutNoCull(getCollarLocation((PembrokeCorgiEntity) entityLivingBaseIn));
