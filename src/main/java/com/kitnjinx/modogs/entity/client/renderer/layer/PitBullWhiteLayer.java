    ...
    public static final Map<ThreeWhiteVariant, ResourceLocation> WHITE_PATTERNS =
            Util.make(Maps.newEnumMap(ThreeWhiteVariant.class), (pat) -> {
                pat.put(ThreeWhiteVariant.WHITE1,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/pit_bull/white/pit_bull_white1.png"));
                pat.put(ThreeWhiteVariant.WHITE2,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/pit_bull/white/pit_bull_white2.png"));
                pat.put(ThreeWhiteVariant.WHITE3,
                        ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/pit_bull/white/pit_bull_white3.png"));
            });

    public static final ResourceLocation NO_PATTERN = ResourceLocation.fromNamespaceAndPath(MoDogs.MOD_ID, "textures/entity/pit_bull/collar/collar_none.png");
