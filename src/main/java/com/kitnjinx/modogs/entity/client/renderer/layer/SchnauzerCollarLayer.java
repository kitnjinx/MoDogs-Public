...
public class SchnauzerCollarLayer extends GeoRenderLayer {
    ...
    public SchnauzerCollarLayer(GeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack poseStack, SchnauzerEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
