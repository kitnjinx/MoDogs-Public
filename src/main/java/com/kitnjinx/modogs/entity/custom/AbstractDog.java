...
public abstract class AbstractDog extends TamableAnimal implements IAnimatable, NeutralMob {
    ...
    /* SPAWN PLACEMENTS */
    public static boolean checkDogSpawnRules(EntityType<? extends AbstractDog> dog, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRandom) {
        return pPos.getY() > pLevel.getSeaLevel() - 1 && isBrightEnoughToSpawn(pLevel, pPos);
    }
}
