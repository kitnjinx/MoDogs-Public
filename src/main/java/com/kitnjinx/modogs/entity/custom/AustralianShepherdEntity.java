...
public class AustralianShepherdEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.australian_shepherd.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.australian_shepherd.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.australian_shepherd.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.australian_shepherd.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.australian_shepherd.idle");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(MERLE_VARIANT, 0);
    }
