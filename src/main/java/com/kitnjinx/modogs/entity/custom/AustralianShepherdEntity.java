        ...
        if (item == ModItems.GENE_TESTER.get()) {
            if (this.level.isClientSide) {
                ...
                if (this.isRed() && this.isMerle()) {
                    message = new TextComponent("This Australian Shepherd demonstrates a recessive trait and merle.");
                } else if (this.isRed()) {
                    message = new TextComponent("This Australian Shepherd demonstrates a recessive trait.");
                } else if (this.carriesRed() && this.isMerle()) {
                    message = new TextComponent("This Australian Shepherd demonstrates the merle trait and carries a recessive trait.");
                } else if (this.carriesRed()) {
                    message = new TextComponent("This Australian Shepherd carries a recessive trait.");
                } else if (this.isMerle()) {
                    message = new TextComponent("This Australian Shepherd demonstrates the merle trait.");
                } else {
                    message = new TextComponent("This Australian Shepherd doesn't have any recessive traits.");
                }
