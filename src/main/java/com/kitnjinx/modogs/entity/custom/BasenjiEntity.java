...
public class BasenjiEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.basenji.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.basenji.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.basenji.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.basenji.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.basenji.idle");
