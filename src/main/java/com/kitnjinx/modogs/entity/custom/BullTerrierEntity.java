...
public class BullTerrierEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.bull_terrier.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.bull_terrier.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.bull_terrier.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.bull_terrier.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.bull_terrier.idle");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(SHOW_TARGET, false);
        builder.define(IS_RED, false);
        builder.define(CARRIES_RED, false);
        builder.define(HIGH_WHITE, true);
        builder.define(PURE_WHITE, true);
