...
public class CockerSpanielEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.cocker_spaniel.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.cocker_spaniel.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.cocker_spaniel.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.cocker_spaniel.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.cocker_spaniel.idle");
