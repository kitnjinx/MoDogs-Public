        ...
        if (item == ModItems.GENE_TESTER.get()) {
            if (this.level.isClientSide) {
                ...
                if (this.isBlack() && this.isMerle()) {
                    message = new TextComponent("This Collie demonstrates a recessive trait and the merle trait.");
                } else if (this.isBlack()) {
                    message = new TextComponent("This Collie demonstrates a recessive trait.");
                } else if (this.carriesBlack() && this.isMerle()) {
                    message = new TextComponent("This Collie demonstrates the merle trait and carries a recessive trait.");
                } else if (this.carriesBlack()) {
                    message = new TextComponent("This Collie carries a recessive trait.");
                } else if (this.isMerle()) {
                    message = new TextComponent("This Collie demonstrates the merle trait.");
                } else {
                    message = new TextComponent("This Collie doesn't have any recessive traits.");
                }
