...
public class DobermanEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.doberman.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.doberman.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.doberman.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.doberman.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.doberman.idle");
