...
public class GermanSpitzEntity extends AbstractDog {
    ...
    private <E extends GermanSpitzEntity> PlayState predicate(AnimationEvent<E> event) {
        if (this.isSitting()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.german_spitz.sitting"));
            return PlayState.CONTINUE;
        }

        if (this.isAngry() || this.isAggressive() & event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.german_spitz.angrywalk"));
            return PlayState.CONTINUE;
        }

        if (event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.german_spitz.walk"));
            return PlayState.CONTINUE;
        }

        if (this.isAngry() || this.isAggressive()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.german_spitz.angryidle"));
            return PlayState.CONTINUE;
        }

        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.german_spitz.idle"));
        return PlayState.CONTINUE;
    }
    @Override
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(CARRIES_WHITE, true);
    }
    ...
    private TextComponent determineGeneTesterMessage() {
        ...
        if (this.getVariant() == GermanSpitzVariant.WHITE && this.isRed()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also have the alleles for red fur and brown fur.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also have the alleles for red fur, and carry the brown fur trait.");
            } else {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also have the alleles for red fur.");
            }
        } else if (this.getVariant() == GermanSpitzVariant.WHITE && this.carriesRed()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also have the alleles for brown fur and carry the red fur trait.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also carry the red fur and brown fur traits.");
            } else {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also carry the red fur trait.");
            }
        } else if (this.getVariant() == GermanSpitzVariant.WHITE) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also have the alleles for brown fur.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait. They also carry the brown fur trait.");
            } else {
                message = new TextComponent("This German Spitz demonstrates the recessive white fur trait.");
            }
        } else if (this.carriesWhite() && this.isRed()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive red fur trait. They also have the alleles for brown fur and carry the white fur trait.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive red fur trait. They also carry the brown fur and white fur traits.");
            } else {
                message = new TextComponent("This German Spitz demonstrates the recessive red fur trait. They also carry the white fur trait.");
            }
        } else if (this.carriesWhite() && this.carriesRed()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive brown fur trait. They also carry the red fur and white fur traits.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz carries three recessive traits.");
            } else {
                message = new TextComponent("This German Spitz carries the red fur and white fur traits.");
            }
        } else if (this.carriesWhite()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive brown fur trait and carries the white fur trait.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz carries the brown fur and white fur traits.");
            } else {
                message = new TextComponent("This German Spitz carries the white fur trait.");
            }
        } else if (this.isRed()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive red fur trait. They also have the alleles for brown fur.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive red fur trait, and carries the brown fur trait.");
            } else {
                message = new TextComponent("This German Spitz demonstrates the recessive red fur trait.");
            }
        } else if (this.carriesRed()) {
            if (this.isBrown()) {
                message = new TextComponent("This German Spitz demonstrates the recessive brown fur trait, and carries the red fur trait.");
            } else if (this.carriesBrown()) {
                message = new TextComponent("This German Spitz carries the red fur and brown fur traits.");
            } else {
                message = new TextComponent("This German Spitz carries the red fur trait.");
            }
        } else if (this.isBrown()) {
            message = new TextComponent("This German Spitz demonstrates the recessive brown fur trait.");
        } else if (this.carriesBrown()) {
            message = new TextComponent("This German Spitz carries the brown fur trait.");
        } else {
            message = new TextComponent("This German Spitz doesn't have any recessive traits.");
        }
