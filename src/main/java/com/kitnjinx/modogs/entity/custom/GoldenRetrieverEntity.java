...
public class GoldenRetrieverEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.golden_retriever.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.golden_retriever.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.golden_retriever.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.golden_retriever.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.golden_retriever.idle");
