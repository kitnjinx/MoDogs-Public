...
public class GreyhoundEntity extends AbstractDog {
    ...
    private <E extends GreyhoundEntity> PlayState predicate(AnimationEvent<E> event) {
        if (this.isSitting()) {
            ...
            if (this.level.isClientSide) {
                ...
                if (this.getVariant() == GreyhoundVariant.WHITE) {
                    if (this.isRed() && this.isBlue()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also have the alleles for diluted red fur.");
                    } else if (this.isRed() && this.isBlueCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also have the alleles for red fur and carry the dilution trait.");
                    } else if (this.isRed()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also have the alleles for red fur.");
                    } else if (this.isBlue() && this.isRedCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also have the alleles for diluted color, and carry the red fur trait.");
                    } else if (this.isBlue()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also have the alleles for diluted color.");
                    } else if (this.isBlueCarrier() && this.isRedCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also carry both the red fur and dilution traits.");
                    } else if (this.isBlueCarrier()) {
                        // pure white and blue carrier
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also carry the dilution trait.");
                    } else if (this.isRedCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat. They also carry the red fur trait.");
                    } else {
                        message = new TextComponent("This Greyhound demonstrates a fully white coat.");
                    }
                } else if (this.isBlue()) {
                    if (this.hasWhite() && this.isRed()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive dilution trait. They also have white markings and the alleles for red fur.");
                    } else if (this.hasWhite() && this.isRedCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive dilution trait. They also have white markings and carry the red fur trait.");
                    } else if (this.hasWhite()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive dilution trait. They also have white markings.");
                    } else if (this.isRed()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive dilution trait. They also have the alleles for red fur.");
                    } else if (this.isRedCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive dilution trait. They also carry the red fur trait.");
                    } else {
                        message = new TextComponent("This Greyhound demonstrates the recessive dilution trait.");
                    }
                } else if (this.isRed()) {
                    if (this.hasWhite() && this.isBlueCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive red fur trait. They also have white markings and carry the dilution trait.");
                    } else if (this.hasWhite()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive red fur trait. They also have white markings.");
                    } else if (this.isBlueCarrier()) {
                        message = new TextComponent("This Greyhound demonstrates the recessive red fur trait. They also carry the dilution trait.");
                    } else {
                        message = new TextComponent("This Greyhound demonstrates the recessive red fur trait.");
                    }
                } else {
                    if (this.hasWhite()) {
                        if (this.isRedCarrier() && this.isBlueCarrier()) {
                            message = new TextComponent("This Greyhound has white markings and carries two recessive traits.");
                        } else if (this.isRedCarrier()) {
                            message = new TextComponent("This Greyhound has white markings and carries the recessive red fur trait.");
                        } else if (this.isBlueCarrier()) {
                            message = new TextComponent("This Greyhound has white markings and carries the recessive dilution trait.");
                        } else {
                            message = new TextComponent("This Greyhound has white markings.");
                        }
                    } else {
                        if (this.isRedCarrier() && this.isBlueCarrier()) {
                            message = new TextComponent("This Greyhound carries two recessive traits.");
                        } else if (this.isRedCarrier()) {
                            message = new TextComponent("This Greyhound carries the recessive red fur trait.");
                        } else if (this.isBlueCarrier()) {
                            message = new TextComponent("This Greyhound carries the recessive dilution trait.");
                        } else {
                            message = new TextComponent("This Greyhound doesn't have any recessive traits.");
                        }
                    }
                }
