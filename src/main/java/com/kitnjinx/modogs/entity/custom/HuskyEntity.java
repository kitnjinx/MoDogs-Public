...
public class HuskyEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.husky.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.husky.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.husky.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.husky.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.husky.idle");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(EYE_COLOR_VARIANT, 0);
        builder.define(IS_RED, false);
        builder.define(CARRIES_RED, false);
        builder.define(IS_SOLID, true);
        builder.define(CARRIES_SOLID, true);
        builder.define(IS_WHITE, false);
