...
public class ItalianGreyhoundEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.italian_greyhound.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.italian_greyhound.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.italian_greyhound.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.italian_greyhound.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.italian_greyhound.idle");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(IS_BLUE, true);
        builder.define(CARRIES_BLUE, true);
        builder.define(IS_FAWN, true);
        builder.define(CARRIES_FAWN, true);
