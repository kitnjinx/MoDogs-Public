...
public class MiniBullTerrierEntity extends AbstractDog {
    ...
    private <E extends MiniBullTerrierEntity> PlayState predicate(AnimationEvent<E> event) {
        if (this.isSitting()) {
            ...
            if (this.level.isClientSide) {
                ...
                if (this.isRed()) {
                    if (this.getVariant() == BullTerrierVariant.WHITE) {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates a fully white coat. They also have the alleles for red fur.");
                    } else if (this.hasHighWhite()) {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates a recessive trait and high amounts of white markings.");
                    } else {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates a recessive trait.");
                    }
                } else if (this.carriesRed()) {
                    if (this.getVariant() == BullTerrierVariant.WHITE) {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates a fully white coat. They also carry a recessive trait.");
                    } else if (this.hasHighWhite()) {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates high amounts of white markings and carries a recessive trait.");
                    } else {
                        message = new TextComponent("This Miniature Bull Terrier carries a recessive trait.");
                    }
                } else {
                    if (this.getVariant() == BullTerrierVariant.WHITE) {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates a fully white coat.");
                    } else if (this.hasHighWhite()) {
                        message = new TextComponent("This Miniature Bull Terrier demonstrates high amounts of white markings.");
                    } else {
                        message = new TextComponent("This Miniature Bull Terrier doesn't have any recessive traits.");
                    }
                }
            } else {
