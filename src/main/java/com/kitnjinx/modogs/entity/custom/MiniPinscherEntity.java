...
public class MiniPinscherEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.mini_pinscher.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.mini_pinscher.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.mini_pinscher.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.mini_pinscher.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.mini_pinscher.idle");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(IS_BLACK, true);
        builder.define(CARRIES_BLACK, true);
        builder.define(IS_DILUTE, false);
        builder.define(CARRIES_DILUTE, false);
    }

    @Override
    public void setTame (boolean tamed, boolean applyTamingSideEffect) {
        super.setTame(tamed, applyTamingSideEffect);
        if (applyTamingSideEffect) {
