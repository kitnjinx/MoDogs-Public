    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (item == ModItems.GENE_TESTER.get()) {
            if (this.level.isClientSide) {
                ...
                if (this.isBlack()) {
                    if (this.isDilute()) {
                        message = new TextComponent("This Miniature Pinscher demonstrates two recessive traits.");
                    } else if (this.carriesDilute()) {
                        message = new TextComponent("This Miniature Pinscher demonstrates the recessive black and tan fur trait and carries the dilution trait.");
                    } else {
                        message = new TextComponent("This Miniature Pinscher demonstrates the recessive black and tan fur trait.");
                    }
                } else if (this.carriesBlack()) {
                    if (this.isDilute()) {
                        message = new TextComponent("This Miniature Pinscher carries the black and tan fur trait, and has the alleles for diluted black.");
                    } else if (this.carriesDilute()) {
                        message = new TextComponent("This Miniature Pinscher carries two recessive traits.");
                    } else {
                        message = new TextComponent("This Miniature Pinscher carries the black and tan fur trait.");
                    }
                } else if (this.isDilute()) {
                    message = new TextComponent("This Miniature Pinscher has the alleles for diluted black.");
                } else if (this.carriesDilute()) {
                    message = new TextComponent("This Miniature Pinscher carries the dilution trait.");
                } else {
                    message = new TextComponent("This Miniature Pinscher doesn't have any recessive traits.");
                }
