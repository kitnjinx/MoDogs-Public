        ...
        if (item == ModItems.GENE_TESTER.get()) {
            if (this.level.isClientSide) {
                ...
                if (this.getVariant() == MiniSchnauzerVariant.PEPPER_SALT) {
                    message = new TextComponent("This Miniature Schnauzer demonstrates a recessive trait.");
                } else if (this.getVariant() == MiniSchnauzerVariant.BLACK_SILVER) {
                    message = new TextComponent("This Miniature Schnauzer demonstrates an incompletely dominant trait.");
                } else {
                    message = new TextComponent("This Miniature Schnauzer doesn't have any recessive traits.");
                }
