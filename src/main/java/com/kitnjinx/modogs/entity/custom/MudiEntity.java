...
public class MudiEntity extends AbstractDog {
    ...
    private <E extends MudiEntity> PlayState predicate(AnimationEvent<E> event) {
        if (this.isSitting()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mudi.sitting"));
            return PlayState.CONTINUE;
        }

        if (this.isAngry() || this.isAggressive() & event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mudi.angrywalk"));
            return PlayState.CONTINUE;
        }

        if (event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mudi.walk"));
            return PlayState.CONTINUE;
        }

        if (this.isAngry() || this.isAggressive()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mudi.angryidle"));
            return PlayState.CONTINUE;
        }

        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.mudi.idle"));
        return PlayState.CONTINUE;
    }
    @Override
            ...
            if (this.level.isClientSide) {
                ...
                if (this.isBrown() && this.hasMerle()) {
                    if (this.getVariant() == MudiVariant.WHITE) {
                        message = new TextComponent("This Mudi demonstrates the recessive white fur trait. They also have the alleles for brown fur and merle.");
                    } else if (this.carriesWhite()) {
                        message = new TextComponent("This Mudi demonstrates the merle and recessive brown fur traits. They also carry the white fur trait.");
                    } else {
                        message = new TextComponent("This Mudi demonstrates the merle and recessive brown fur traits.");
                    }
                } else if (this.isBrown()) {
                    if (this.getVariant() == MudiVariant.WHITE) {
                        message = new TextComponent("This Mudi demonstrates the recessive white fur trait. They also have the alleles for brown fur.");
                    } else if (this.carriesWhite()) {
                        message = new TextComponent("This Mudi demonstrates the recessive brown fur trait and carries the white fur trait.");
                    } else {
                        message = new TextComponent("This Mudi demonstrates the recessive brown fur trait.");
                    }
                } else if (this.carriesBrown() && this.hasMerle()) {
                    if (this.getVariant() == MudiVariant.WHITE) {
                        message = new TextComponent("This Mudi demonstrates the recessive white fur trait. They also have the merle trait and carry the brown fur trait.");
                    } else if (this.carriesWhite()) {
                        message = new TextComponent("This Mudi demonstrates the merle trait, and carries two recessive traits.");
                    } else {
                        message = new TextComponent("This Mudi demonstrates the merle trait, and carries the brown fur trait.");
                    }
                } else if (this.carriesBrown()) {
                    if (this.getVariant() == MudiVariant.WHITE) {
                        message = new TextComponent("This Mudi demonstrates the recessive white fur trait and carries the brown fur trait.");
                    } else if (this.carriesWhite()) {
                        message = new TextComponent("This Mudi carries two recessive traits.");
                    } else {
                        message = new TextComponent("This Mudi carries the recessive brown fur trait.");
                    }
                } else if (this.hasMerle()) {
                    if (this.getVariant() == MudiVariant.WHITE) {
                        message = new TextComponent("This Mudi demonstrates the recessive white fur trait, and also has the merle trait.");
                    } else if (this.carriesWhite()) {
                        message = new TextComponent("This Mudi demonstrates the merle trait and carries the white fur trait.");
                    } else {
                        message = new TextComponent("This Mudi demonstrates the merle trait.");
                    }
                } else if (this.getVariant() == MudiVariant.WHITE){
                    message = new TextComponent("This Mudi demonstrates the recessive white fur trait.");
                } else if (this.carriesWhite()) {
                    message = new TextComponent("This Mudi carries the white fur trait.");
                } else {
                    message = new TextComponent("This Mudi doesn't have any recessive traits.");
                }
