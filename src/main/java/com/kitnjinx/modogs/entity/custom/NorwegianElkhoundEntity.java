...
public class NorwegianElkhoundEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.norwegian_elkhound.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.norwegian_elkhound.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.norwegian_elkhound.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.norwegian_elkhound.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.norwegian_elkhound.idle");
