...
public class PoodleEntity extends AbstractDog {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState state) {
        if (this.isSitting()) {
            state.getController().setAnimation(RawAnimation.begin().then("animation.poodle.sitting", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }

        if (this.isAngry() || this.isAggressive() & state.isMoving()) {
            state.getController().setAnimation(RawAnimation.begin().then("animation.poodle.angrywalk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }

        if (state.isMoving()) {
            state.getController().setAnimation(RawAnimation.begin().then("animation.poodle.walk", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }

        if (this.isAngry() || this.isAggressive()) {
            state.getController().setAnimation(RawAnimation.begin().then("animation.poodle.angryidle", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }

        state.getController().setAnimation(RawAnimation.begin().then("animation.poodle.idle", Animation.LoopType.LOOP));
        return PlayState.CONTINUE;
    }
    @Override
            ...
            if (this.level.isClientSide) {
                ...
                if (this.getVariant() == PoodleVariant.WHITE) {
                    if (this.isBrown() && this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also have the alleles for diluted brown fur.");
                    } else if (this.isBrown() && this.carriesDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also have the alleles for brown fur and carry the dilution trait.");
                    } else if (this.isBrown()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also have the alleles for brown fur.");
                    } else if (this.carriesBrown() && this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also have the alleles for diluted fur and carry the brown fur trait.");
                    } else if (this.carriesBrown() && this.carriesDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also carry the dilution and brown fur traits.");
                    } else if (this.carriesBrown()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also carry the brown fur trait.");
                    } else if (this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also have the alleles for diluted fur.");
                    } else if (this.carriesDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait. They also carry the dilution trait.");
                    } else {
                        message = Component.literal("This Poodle demonstrates the recessive white fur trait.");
                    }
                } else if (this.carriesWhite()) {
                    if (this.isBrown() && this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive brown fur and dilutions traits. They also carry the white fur trait.");
                    } else if (this.isBrown() && this.carriesDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive brown fur trait. They also carry the dilution and white fur traits.");
                    } else if (this.isBrown()) {
                        message = Component.literal("This Poodle demonstrates the recessive brown fur trait. They also carry the white fur trait.");
                    } else if (this.carriesBrown() && this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive dilution trait. They also carry the white and brown fur traits.");
                    } else if (this.carriesBrown() && this.carriesDilute()) {
                        message = Component.literal("This Poodle carries three recessive traits.");
                    } else if (this.carriesBrown()) {
                        message = Component.literal("This Poodle carries the white and brown fur traits.");
                    } else if (this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive dilution trait and carries the trait for white fur.");
                    } else if (this.carriesDilute()) {
                        message = Component.literal("This Poodle carries the white fur and dilution traits.");
                    } else {
                        message = Component.literal("This Poodle carries the white fur trait.");
                    }
                } else {
                    if (this.isBrown() && this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive brown fur and dilution traits.");
                    } else if (this.isBrown() && this.carriesDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive brown fur trait, and carries the dilution trait.");
                    } else if (this.isBrown()) {
                        message = Component.literal("This Poodle demonstrates the recessive brown fur trait.");
                    } else if (this.carriesBrown() && this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the recessive dilution trait, and carries the brown fur trait.");
                    } else if (this.carriesBrown() && this.carriesDilute()) {
                        message = Component.literal("This Poodle carries the brown fur and dilution traits.");
                    } else if (this.carriesBrown()) {
                        message = Component.literal("This Poodle carries the brown fur trait.");
                    } else if (this.isDilute()) {
                        message = Component.literal("This Poodle demonstrates the dilution trait.");
                    } else if (this.carriesDilute()) {
                        message = Component.literal("This Poodle carries the dilution trait.");
                    } else {
                        message = Component.literal("This Poodle doesn't have any recessive traits.");
                    }
