        ...
        if (item == ModItems.GENE_TESTER.get()) {
            if (this.level.isClientSide) {
                ...
                if (this.isTan() && this.isMahogany()) {
                    message = new TextComponent("This Rottweiler demonstrates a recessive trait. They also have the alleles for a rare point color.");
                } else if (this.isTan()) {
                    message = new TextComponent("This Rottweiler demonstrates a recessive trait.");
                } else if (this.carriesTan() && this.isMahogany()) {
                    message = new TextComponent("This Rottweiler demonstrates a rare point color, and carries a recessive trait.");
                } else if (this.carriesTan()) {
                    message = new TextComponent("This Rottweiler carries a recessive trait.");
                } else if (this.isMahogany()) {
                    message = new TextComponent("This Rottweiler demonstrates a rare point color.");
                } else {
                    message = new TextComponent("This Rottweiler doesn't have any recessive traits.");
                }
