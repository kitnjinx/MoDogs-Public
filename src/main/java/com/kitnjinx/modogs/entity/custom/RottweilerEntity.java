...
public class RottweilerEntity extends AbstractDog {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        RawAnimation sitting = RawAnimation.begin().thenLoop("animation.rottweilder.sitting");
        RawAnimation angryWalk = RawAnimation.begin().thenLoop("animation.rottweilder.angrywalk");
        RawAnimation walk = RawAnimation.begin().thenLoop("animation.rottweilder.walk");
        RawAnimation angryIdle = RawAnimation.begin().thenLoop("animation.rottweilder.angryidle");
        RawAnimation idle = RawAnimation.begin().thenLoop("animation.rottweilder.idle");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(IS_MAHOGANY, false);
    }
