        ...
        if (item == ModItems.GENE_TESTER.get()) {
            if (this.level.isClientSide) {
                ...
                if (this.getVariant() == SchnauzerVariant.PEPPER_SALT) {
                    message = new TextComponent("This Schnauzer demonstrates a recessive trait.");
                } else if (this.getCarrier()) {
                    message = new TextComponent("This Schnauzer carries a recessive trait.");
                } else {
                    message = new TextComponent("This Schnauzer doesn't have any recessive traits.");
                }
