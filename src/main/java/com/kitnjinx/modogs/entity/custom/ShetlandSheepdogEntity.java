            ...
            if (this.level.isClientSide) {
                ...
                if (this.hasMerle()) {
                    if (this.isSable() && this.isTan()) {
                        message = new TextComponent("This Shetland Sheepdog demonstrates the merle and recessive sable fur traits. They also have the alleles for the recessive points trait.");
                    } else if (this.isSable()) {
                        if (this.carriesTan()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle and recessive sable fur traits. They also carry the points trait.");
                        } else {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle and recessive sable fur traits.");
                        }
                    } else if (this.isTan()) {
                        if (this.carriesSable()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle and recessive points trait. They also carry the sable fur trait.");
                        } else {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle and recessive points trait.");
                        }
                    } else {
                        if (this.carriesSable() && this.carriesTan()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle trait, and carries two recessive traits.");
                        } else if (this.carriesTan()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle trait, and carries the recessive points trait.");
                        } else if (this.carriesSable()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle trait, and carries the recessive sable fur trait.");
                        } else {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the merle trait.");
                        }
                    }
                } else {
                    if (this.isSable() && this.isTan()) {
                        message = new TextComponent("This Shetland Sheepdog demonstrates the recessive sable fur trait. They also have the alleles for the recessive points trait.");
                    } else if (this.isSable()) {
                        if (this.carriesTan()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the recessive sable fur trait, and carries the points trait.");
                        } else {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the recessive sable fur trait.");
                        }
                    } else if (this.isTan()) {
                        if (this.carriesSable()) {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the recessive points trait, and carries the recessive sable fur trait.");
                        } else {
                            message = new TextComponent("This Shetland Sheepdog demonstrates the recessive points trait.");
                        }
                    } else {
                        if (this.carriesSable() && this.carriesTan()) {
                            message = new TextComponent("This Shetland Sheepdog carries two recessive traits.");
                        } else if (this.carriesTan()) {
                            message = new TextComponent("This Shetland Sheepdog carries the recessive points trait.");
                        } else if (this.carriesSable()) {
                            message = new TextComponent("This Shetland Sheepdog carries the recessive sable fur trait.");
                        } else {
                            message = new TextComponent("This Shetland Sheepdog doesn't have any recessive traits.");
                        }
                    }
