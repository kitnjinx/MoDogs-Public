...
public class ToyPoodleEntity extends AbstractDog {
    ...
    private <E extends ToyPoodleEntity> PlayState predicate(AnimationEvent<E> event) {
        if (this.isSitting()) {
            ...
            if (this.level.isClientSide) {
                ...
                if (this.getVariant() == PoodleVariant.WHITE) {
                    if (this.isBrown() && this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also have the alleles for diluted brown fur.");
                    } else if (this.isBrown() && this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also have the alleles for brown fur and carry the dilution trait.");
                    } else if (this.isBrown()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also have the alleles for brown fur.");
                    } else if (this.carriesBrown() && this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also have the alleles for diluted fur and carry the brown fur trait.");
                    } else if (this.carriesBrown() && this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also carry the dilution and brown fur traits.");
                    } else if (this.carriesBrown()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also carry the brown fur trait.");
                    } else if (this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also have the alleles for diluted fur.");
                    } else if (this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait. They also carry the dilution trait.");
                    } else {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive white fur trait.");
                    }
                } else if (this.carriesWhite()) {
                    if (this.isBrown() && this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive brown fur and dilutions traits. They also carry the white fur trait.");
                    } else if (this.isBrown() && this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive brown fur trait. They also carry the dilution and white fur traits.");
                    } else if (this.isBrown()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive brown fur trait. They also carry the white fur trait.");
                    } else if (this.carriesBrown() && this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive dilution trait. They also carry the white and brown fur traits.");
                    } else if (this.carriesBrown() && this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle carries three recessive traits.");
                    } else if (this.carriesBrown()) {
                        message = new TextComponent("This Toy Poodle carries the white and brown fur traits.");
                    } else if (this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive dilution trait and carries the trait for white fur.");
                    } else if (this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle carries the white fur and dilution traits.");
                    } else {
                        message = new TextComponent("This Toy Poodle carries the white fur trait.");
                    }
                } else {
                    if (this.isBrown() && this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive brown fur and dilution traits.");
                    } else if (this.isBrown() && this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive brown fur trait, and carries the dilution trait.");
                    } else if (this.isBrown()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive brown fur trait.");
                    } else if (this.carriesBrown() && this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the recessive dilution trait, and carries the brown fur trait.");
                    } else if (this.carriesBrown() && this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle carries the brown fur and dilution traits.");
                    } else if (this.carriesBrown()) {
                        message = new TextComponent("This Toy Poodle carries the brown fur trait.");
                    } else if (this.isDilute()) {
                        message = new TextComponent("This Toy Poodle demonstrates the dilution trait.");
                    } else if (this.carriesDilute()) {
                        message = new TextComponent("This Toy Poodle carries the dilution trait.");
                    } else {
                        message = new TextComponent("This Toy Poodle doesn't have any recessive traits.");
                    }
